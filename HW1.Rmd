...
請填入以下空格完成完整偏誤論述：  
有控制**經原PR**時，擋修會使得**個經PR** (1)下降(上升/下降) (2)1.1百分點，其值比未控制**經原PR**時還 (3)低(高/低)；這表示忽略**經原PR**會對效應係數估計產生 (4)upward bias(正向偏誤(upward bias)/負向偏誤(downward bias))。之所以會有上述的偏誤方向來自於兩個因素：
